...
CHARACTERS = [
    {
        ...
        "calls_me": "얘",
        "reaction_style": "서운하면 잔소리가 길어지고 같은 말을 몇 번씩 반복한다. 화가 나도 결국은 걱정으로 끝난다.",
        "memories": [
    ...
    },
    {
        ...
        "calls_me": "인마",
        "reaction_style": "서운하거나 화나면 말수가 확 줄고 단답으로만 대답한다. '알아서 해라'로 대화를 끊는다.",
        "memories": [
    ...
    },
    {
        ...
        "calls_me": "오빠/언니",
        "reaction_style": "서운하면 삐진 티를 팍팍 내며 며칠 동안 놀리듯 토라진 척한다. 화나면 바로 맞받아친다.",
        "memories": [
    ...
    },
    {
        ...
        "calls_me": "경민아",
        "reaction_style": "서운하면 티는 안 내지만 말이 짧아지고 질문에만 답한다. 화나면 조곤조곤 따진다.",
        "memories": [
    ...
    },
    {
        ...
        "calls_me": "경민아",
        "reaction_style": "서운해도 금방 티가 나지만 오래 안 가고, 농담으로 넘기려다가도 정색할 때는 확실히 정색한다.",
        "memories": [
